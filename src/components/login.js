...
const [formData, setFormData] = useState({
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Perform form submission logic here (e.g., API calls)
  ...
  <div class="h-full">
    ...
    <div
      ...
      <div class="mb-12 border p-12 rounded-lg md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
        <form onSubmit={handleSubmit}>
          
          <div
            class="flex flex-row items-center justify-center lg:justify-start">
            <p class="mb-0 mr-4 text-lg">Log in with</p>
          ...
          <div
            ...
            <p
              class="mx-4 mb-0 text-center font-semibold dark:">
              Or
            </p>
          </div>
